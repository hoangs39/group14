...
//         cm.addCart(c1);
//         // Loader.writeCartsIntoFile(cm.getShoppingCarts());
//         // cm.addCart(c2);
...
//         CartsManager cartsManager = Loader.retriveCartsFromDatabase(productManager, "carts.txt");
//         // cartsManager.getCartById("C1");
//         // System.out.println(cartsManager.getCartById("C1").getItemsList().get(2));
//         Loader.writeCartsIntoFile(cartsManager.getShoppingCarts());
//         // cartsManager.displayCarts();
